...
const CATEGORIES: CategorySpec[] = [
  ...
  { category: 'crumbs', label: '과자부스러기', emoji: '✨', defaultSize: { w: 30, h: 30 }, variants: 6,
    instances: [
      ...
      { x: 855, y: 720, w: 21, h: 22, z: 39, v: 4 },
      { x: 946, y: 831, w: 87, h: 49, z: 4, v: 5 },
      { x: 547, y: 834, w: 58, h: 45, z: 5, v: 6 },
      { x: 1060, y: 596, w: 34, h: 29, z: 73, v: 1 },
      { x: 248, y: 809, w: 45, h: 22, z: 48, v: 2 },
  ...
  { category: 'tissueroll', label: '두루마리휴지', emoji: '🧻', defaultSize: { w: 120, h: 90 },
    instances: [
      { x: 974, y: 532, w: 107, h: 82, z: 76 },
      { x: 230, y: 871, w: 120, h: 92, z: 53 },
      { x: 1099, y: 1045, w: 161, h: 123, z: 57 },
    ] },

  { category: 'beer', label: '맥주', emoji: '🍻', defaultSize: { w: 55, h: 100 },
    instances: [
      { x: 1189, y: 565, w: 53, h: 99, z: 46 },
      { x: 563, y: 513, w: 51, h: 95, z: 50 },
      { x: 289, y: 578, w: 50, h: 94, z: 10 },
      { x: 1376, y: 873, w: 59, h: 111, z: 56 },
      { x: 1182, y: 817, w: 54, h: 102, z: 11 },
      { x: 590, y: 919, w: 65, h: 122, z: 63, r: 1.50 },  // 쓰러짐
      { x: 1421, y: 803, w: 50, h: 94, z: 55 },
      { x: 1344, y: 857, w: 60, h: 113, z: 54, r: -1.40 }, // 쓰러짐
      { x: 743, y: 888, w: 53, h: 99, z: 12 },
      { x: 781, y: 715, w: 54, h: 101, z: 68 },
      { x: 746, y: 723, w: 60, h: 113, z: 69 },
      { x: 760, y: 665, w: 50, h: 94, z: 67 },
      { x: 290, y: 762, w: 51, h: 96, z: 70 },
      { x: 955, y: 1040, w: 58, h: 108, z: 13, r: 1.50 }, // 쓰러짐
    ] },

  { category: 'beercup', label: '맥주컵', emoji: '🍺', defaultSize: { w: 63, h: 77 },
    instances: [
      { x: 452, y: 529, w: 63, h: 77, z: 14 },
      { x: 919, y: 795, w: 65, h: 80, z: 78 },
    ] },

  { category: 'plastic', label: '비닐봉지', emoji: '🛍️', defaultSize: { w: 130, h: 110 }, variants: 2,
    instances: [
      { x: 1155, y: 376, w: 110, h: 101, z: 15, v: 1 },
      { x: 349, y: 867, w: 137, h: 115, z: 42, v: 2 },
      { x: 1541, y: 719, w: 139, h: 127, z: 83, v: 1 },
      { x: 936, y: 734, w: 144, h: 121, z: 77, v: 2 },
    ] },

  { category: 'redcup', label: '빨간컵', emoji: '🥤', defaultSize: { w: 67, h: 90 },
    instances: [
      { x: 1042, y: 920, w: 67, h: 90, z: 80 },
      { x: 691, y: 939, w: 67, h: 90, z: 38 },
      { x: 658, y: 909, w: 64, h: 87, z: 16 },
      { x: 1471, y: 759, w: 67, h: 91, z: 84 },
      { x: 1309, y: 776, w: 55, h: 74, z: 59 },
      { x: 1036, y: 775, w: 62, h: 84, z: 37 },
    ] },

  { category: 'soju', label: '소주', emoji: '🍶', defaultSize: { w: 40, h: 114 },
    instances: [
      { x: 579, y: 672, w: 40, h: 114, z: 17 },
      { x: 699, y: 664, w: 43, h: 125, z: 35 },
      { x: 689, y: 592, w: 33, h: 94, z: 18 },
      { x: 828, y: 938, w: 55, h: 159, z: 60, r: 1.50 },  // 쓰러짐 (바닥)
      { x: 558, y: 891, w: 53, h: 152, z: 62, r: -1.50 }, // 쓰러짐 (반대)
      { x: 118, y: 561, w: 44, h: 126, z: 19 },
      { x: 204, y: 586, w: 45, h: 131, z: 20 },
      { x: 651, y: 687, w: 46, h: 132, z: 34, r: 1.30 },  // 살짝 쓰러짐 (테이블)
  ...
  { category: 'towel', label: '수건', emoji: '🧴', defaultSize: { w: 173, h: 175 },
    instances: [
      { x: 840, y: 575, w: 173, h: 175, z: 52 },
      { x: 1386, y: 723, w: 169, h: 171, z: 58 },
    ] },

  { category: 'pizza', label: '피자', emoji: '🍕', defaultSize: { w: 200, h: 150 }, variants: 3,
    instances: [
      { x: 1237, y: 940, w: 390, h: 238, z: 81, v: 1 },
      { x: 772, y: 1018, w: 175, h: 91, z: 61, v: 2 },
      { x: 644, y: 1002, w: 136, h: 92, z: 47, v: 3 },
    ] },

  { category: 'tissue', label: '휴지뭉치', emoji: '🧻', defaultSize: { w: 50, h: 50 }, variants: 3,
    instances: [
      { x: 1245, y: 399, w: 49, h: 44, z: 45, v: 1 },
      { x: 1040, y: 556, w: 111, h: 60, z: 74, v: 2 },
      { x: 772, y: 192, w: 78, h: 42, z: 44, v: 3 },
      { x: 738, y: 949, w: 52, h: 47, z: 23, v: 1 },
      { x: 331, y: 595, w: 51, h: 27, z: 24, v: 2 },
      { x: 864, y: 1054, w: 49, h: 26, z: 25, v: 3 },
      { x: 1027, y: 982, w: 49, h: 44, z: 41, v: 1 },
