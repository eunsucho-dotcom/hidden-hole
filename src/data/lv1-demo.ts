...
const CATEGORIES: CategorySpec[] = [
  { category: 'browncup', label: '갈색컵', emoji: '🥃', defaultSize: { w: 38, h: 54 },
    instances: [
      { x: 376, y: 570, w: 44, h: 63, z: 45 },
      { x: 1123, y: 573, w: 49, h: 69, z: 46 },
  ...
  { category: 'tissueroll', label: '두루마리휴지', emoji: '🧻', defaultSize: { w: 120, h: 90 },
    instances: [
      { x: 995, y: 549, w: 107, h: 82, z: 62 },
      { x: 258, y: 841, w: 120, h: 92, z: 40 },
      { x: 1095, y: 1027, w: 161, h: 123, z: 37 },
    ] },

  { category: 'beer', label: '맥주', emoji: '🍻', defaultSize: { w: 55, h: 100 },
    instances: [
      { x: 1189, y: 565, w: 53, h: 99, z: 15 },
      { x: 588, y: 497, w: 51, h: 95, z: 50 },
      ...
      { x: 813, y: 693, w: 54, h: 101, z: 51 },
      { x: 738, y: 718, w: 60, h: 113, z: 53 },
      { x: 765, y: 657, w: 50, h: 94, z: 52 },
  ...
  { category: 'beercup', label: '맥주컵', emoji: '🍺', defaultSize: { w: 63, h: 77 },
    instances: [
      { x: 501, y: 520, w: 63, h: 77, z: 43 },
      { x: 927, y: 773, w: 65, h: 80, z: 64 },
    ] },

  { category: 'plastic', label: '비닐봉지', emoji: '🛍️', defaultSize: { w: 130, h: 110 }, variants: 2,
    instances: [
      { x: 1156, y: 363, w: 110, h: 101, z: 33 },
      { x: 349, y: 867, w: 137, h: 115, z: 41 },
      { x: 1519, y: 703, w: 119, h: 109, z: 56 },
      { x: 933, y: 718, w: 144, h: 121, z: 63 },
    ] },
  ...
  { category: 'soju', label: '소주', emoji: '🍶', defaultSize: { w: 40, h: 114 },
    instances: [
      ...
      { x: 773, y: 168, w: 39, h: 113, z: 47, r: 1.60 },
  ...
  { category: 'tissue', label: '휴지뭉치', emoji: '🧻', defaultSize: { w: 50, h: 50 }, variants: 1,
    instances: [
      { x: 767, y: 182, w: 43, h: 39, z: 49 },
      { x: 738, y: 949, w: 52, h: 47, z: 10 },
      { x: 573, y: 797, w: 49, h: 44, z: 39 },
      { x: 921, y: 971, w: 58, h: 52, z: 38 },
      { x: 1231, y: 791, w: 43, h: 39, z: 35 },
      { x: 1230, y: 398, w: 49, h: 44, z: 48 },
    ] },

  { category: 'letter', label: '편지', emoji: '✉️', defaultSize: { w: 148, h: 96 },
    instances: [
      { x: 1560, y: 739, w: 148, h: 96, z: 59 },
    ] },

  { category: 'box', label: '박스', emoji: '📦', defaultSize: { w: 231, h: 203 },
    instances: [
      { x: 1548, y: 807, w: 231, h: 203, z: 58 },
    ] },

  { category: 'pants', label: '바지', emoji: '👖', defaultSize: { w: 244, h: 232 },
    instances: [
      { x: 999, y: 597, w: 244, h: 232, z: 61 },
    ] },
