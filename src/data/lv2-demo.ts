...
const CATEGORIES: CategorySpec[] = [
  ...
  { category: 'greenonion', label: '파', emoji: '🌿', defaultSize: { w: 150, h: 80 },
    instances: [
      { x: 400, y: 544, w: 150, h: 80, z: 9 },
      { x: 570, y: 929, w: 192, h: 102, z: 10 },
    ] },
  ...
  { category: 'soysauce', label: '간장', emoji: '🍯', defaultSize: { w: 68, h: 183 },
    instances: [
      { x: 821, y: 344, w: 48, h: 128, z: 3 },
      { x: 1473, y: 161, w: 43, h: 116, z: 17 },
      { x: 587, y: 893, w: 55, h: 147, z: 4, r: -1.50 },
    ] },
