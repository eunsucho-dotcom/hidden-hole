...
const CATEGORIES: CategorySpec[] = [
  { category: 'apple', label: '사과', emoji: '🍎', defaultSize: { w: 105, h: 97 },
    instances: [
      { x: 872, y: 1022, w: 105, h: 97, z: 36 },
      { x: 401, y: 554, w: 105, h: 97, z: 43 },
    ] },

  { category: 'chicken', label: '치킨', emoji: '🍗', defaultSize: { w: 126, h: 62 },
    instances: [
      { x: 528, y: 531, w: 126, h: 62, z: 39 },
    ] },

  { category: 'cibdunebt', label: '양념통', emoji: '🧂', defaultSize: { w: 50, h: 90 }, variants: 4,
    instances: [
      { x: 728, y: 383, w: 44, h: 82, z: 50, v: 1 },
      { x: 998, y: 323, w: 38, h: 64, z: 32, v: 2 },
      { x: 968, y: 335, w: 38, h: 64, z: 33, v: 3 },
      { x: 865, y: 351, w: 51, h: 122, z: 22, v: 4 },
      { x: 932, y: 757, w: 42, h: 78, z: 14, v: 1 },
      { x: 480, y: 500, w: 39, h: 67, z: 38, v: 2 },
      { x: 1506, y: 777, w: 47, h: 78, z: 47, r: 0.20, v: 3 },
      { x: 310, y: 201, w: 42, h: 78, z: 52, v: 1 },
      { x: 870, y: 211, w: 40, h: 74, z: 51, v: 1 },
    ] },

  { category: 'cup', label: '컵', emoji: '☕', defaultSize: { w: 95, h: 76 },
    instances: [
      { x: 868, y: 874, w: 95, h: 76, z: 10, r: -0.60 },
      { x: 697, y: 471, w: 70, h: 56, z: 23, r: 0.20 },
  ...
  { category: 'dishcloth', label: '행주', emoji: '🧻', defaultSize: { w: 84, h: 73 },
    instances: [
      { x: 791, y: 405, w: 84, h: 73, z: 15, r: -0.10 },
      { x: 1166, y: 910, w: 118, h: 102, z: 16, r: -0.70 },
      { x: 630, y: 819, w: 78, h: 68, z: 53, r: 0.60 },
      { x: 1306, y: 408, w: 78, h: 68, z: 17, r: 1.10 },
    ] },

  { category: 'eeg', label: '깨진 계란', emoji: '🥚', defaultSize: { w: 101, h: 97 },
    instances: [
      { x: 1088, y: 650, w: 101, h: 97, z: 27 },
      { x: 1413, y: 895, w: 111, h: 106, z: 29 },
      { x: 740, y: 1033, w: 95, h: 91, z: 30 },
      { x: 834, y: 410, w: 100, h: 96, z: 31 },
    ] },

  { category: 'flour', label: '밀가루', emoji: '🌾', defaultSize: { w: 130, h: 104 },
    instances: [
      { x: 1251, y: 405, w: 130, h: 104, z: 18 },
      { x: 930, y: 1058, w: 165, h: 133, z: 37 },
      { x: 916, y: 706, w: 144, h: 116, z: 6 },
    ] },
  ...
  { category: 'milk', label: '우유', emoji: '🥛', defaultSize: { w: 71, h: 111 },
    instances: [
      { x: 928, y: 366, w: 71, h: 111, z: 34 },
      { x: 1430, y: 183, w: 67, h: 105, z: 35 },
    ] },
  ...
  { category: 'nife', label: '칼', emoji: '🔪', defaultSize: { w: 71, h: 130 },
    instances: [
      { x: 1136, y: 726, w: 71, h: 130, z: 40 },
      { x: 934, y: 183, w: 47, h: 86, z: 42, r: 0.70 },
    ] },

  { category: 'onion', label: '양파', emoji: '🧅', defaultSize: { w: 116, h: 111 },
    instances: [
      { x: 1413, y: 833, w: 116, h: 111, z: 28 },
      { x: 425, y: 490, w: 116, h: 111, z: 9 },
    ] },

  { category: 'scissors', label: '가위', emoji: '✂️', defaultSize: { w: 105, h: 72 },
    instances: [
      { x: 1275, y: 450, w: 105, h: 72, z: 19 },
      { x: 1501, y: 228, w: 105, h: 72, z: 21, r: -0.50 },
      { x: 1148, y: 730, w: 141, h: 97, z: 41, r: -0.50 },
      { x: 661, y: 455, w: 115, h: 79, z: 24, r: -0.70 },
      { x: 599, y: 956, w: 147, h: 101, z: 25, r: -0.40 },
    ] },

  { category: 'scoop', label: '국자', emoji: '🥄', defaultSize: { w: 112, h: 118 },
    instances: [
      { x: 697, y: 456, w: 112, h: 118, z: 44, r: 0.40 },
      { x: 1190, y: 350, w: 74, h: 78, z: 46 },
      { x: 1307, y: 32, w: 90, h: 96, z: 45, r: 1.00 },
    ] },

  { category: 'soup', label: '국', emoji: '🍲', defaultSize: { w: 136, h: 128 },
    instances: [
      { x: 578, y: 791, w: 136, h: 128, z: 54 },
    ] },
  ...
  { category: 'soysauce', label: '간장', emoji: '🍯', defaultSize: { w: 68, h: 183 },
    instances: [
      { x: 1023, y: 750, w: 68, h: 183, z: 26 },
      { x: 821, y: 344, w: 48, h: 128, z: 4 },
      { x: 1473, y: 161, w: 43, h: 116, z: 20 },
  ...
  { category: 'spoon', label: '숟가락', emoji: '🥄', defaultSize: { w: 120, h: 116 },
    instances: [
      ...
      { x: 1485, y: 809, w: 93, h: 90, z: 48, r: -0.40 },
    ] },
